...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--name', type=str, default="vanila_vae_tf", help='Name of experiment(For creating save root)')
        ...
        self.parser.add_argument('--dataset_type', type=str, default='humanact12', help='Type of motion data')
