...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--name_ext', type=str, default="R0", help='Extension of save path')

        # Prova col numero 
        self.parser.add_argument('--num', type=int, default=0, help='Numero animazione')
